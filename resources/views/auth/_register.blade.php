...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}">Sis<b>Med</b></a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Registrarse como usuario del sistema</p>
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('primary_phone') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="primary_phone" value="{{ old('primary_phone') }}" placeholder="Teléfono">
