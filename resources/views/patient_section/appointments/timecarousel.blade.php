      <div class="row desktop" style="display:none;">
        <div class="col-lg-12">
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="carouselshow" class="carousel slide carousel-msg appointments-carousel" data-ride="carousel" data-interval="false" style="display:none;">
                ...
                <a class="left carousel-control" href="#carouselshow" data-slide="prev">
                  <span class="fa fa-angle-left"></span>
                </a>
                <a class="right carousel-control" href="#carouselshow" data-slide="next">
