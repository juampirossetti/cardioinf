...
<head>
    ...
    <meta property="og:title" content="Sismed" />
    ...
    <link href="{{ asset('/la-assets/css/main.css') }}?v={{ config('app.version') }}" rel="stylesheet">

    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Raleway:400,300,700' rel='stylesheet' type='text/css'>

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
    <script src="{{ asset('/la-assets/js/smoothscroll.js') }}?v={{ config('app.version') }}"></script>
...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>Sismed</b></a>
        </div>
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li><a href="{{ url('admin/users') }}">{{ Auth::user()->name }}</a></li>
                @endif
            </ul>
        </div><!--/.nav-collapse -->
    </div>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1>Sistema de turnos médicos <b><a>SisMed</a></b></h1>
                <h3>Descripción</h3>
                <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">¡Iniciar!</a></h3><br>
            </div>
            <div class="col-lg-2">
