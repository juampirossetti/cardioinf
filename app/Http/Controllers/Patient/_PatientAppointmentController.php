...
class PatientAppointmentController extends AppBaseController
{
    ...
    public function index(PatientAppointmentDataTable $appointmentDataTable)
    {
        ...
        return $appointmentDataTable->with('patient_id', Auth::user()->patient->id)->render('patient_section.appointments.index',['professionals' => $professionals, 'medicalStudies' => $medicalStudies]);
    }
    ...
    public function create(Request $request)
    {
        ...
        if( $request->has('professional_id') ){ //con profesional asignado
            ...
            $professional->name = 'Sin Profesional Asignado';
    ...
    {   
        ...
        if ($status == 'error'){
            Flash::error('Hubo un error con la reserva de su turno. Por favor intente nuevamente.');
