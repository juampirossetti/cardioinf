$(document).ready(function() {
    ...
    var showConfirmDialog = function(calEvent){
        ...
        if (calEvent.patient_id != undefined || calEvent.patient_email != null){//con paciente
    ...
    var showEditAppointmentModal = function(calEvent, jsEvent, view) {
        ...
        if((calEvent.pati_id == null || calEvent.owner == 'other') && (calEvent.patient_name != null || calEvent.patient_surname != null)){
    ...
    $('.search-confirm').on('click', function(){
        ...
        if(patientSearched == false){
            alert('Debe presionar el botón Buscar antes de utilizar un número de DNI '+ 
